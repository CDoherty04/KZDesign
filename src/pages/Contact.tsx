    ...
    <Container maxW="container.lg" py={{ base: 8, md: 16 }} px={{ base: 4, md: 6 }}>
      <VStack spacing={{ base: 8, md: 16 }}>
        <VStack spacing={{ base: 4, md: 6 }} textAlign="center" maxW="3xl">
          <Heading as="h1" size={{ base: "xl", md: "2xl" }} color="brand.700" fontFamily="heading">
            Get in Touch
          </Heading>
          <Text fontSize={{ base: "md", md: "lg" }} color="brand.600" fontFamily="body">
        ...
        >
          ...
          >
            <VStack spacing={6} as="form">
              ...
              <FormControl isRequired>
                <FormLabel color="brand.700">Phone</FormLabel>
          ...
          >
            <VStack spacing={{ base: 6, md: 8 }} align="start" w="full">
              <Heading as="h2" size={{ base: "md", md: "lg" }} color="brand.700" fontFamily="heading">
                Contact Information
              </Heading>
              ...
              <VStack spacing={6} align="start" w="full">
                <HStack spacing={4}>
                  ...
                  <VStack align="start" spacing={0}>
                    <Text fontWeight="medium" color="brand.700">Phone</Text>
                ...
                <HStack spacing={4}>
                  ...
                  <VStack align="start" spacing={0}>
                    <Text fontWeight="medium" color="brand.700">Email</Text>
                    <Text color="brand.600">
                ...
                <HStack spacing={4}>
                  ...
                  <VStack align="start" spacing={0}>
                    <Text fontWeight="medium" color="brand.700">Studio</Text>
                    <Text color="brand.600">
                      123 Design Street
                      <br />
              ...
              <VStack spacing={4} align="start" w="full">
                <Heading as="h3" size={{ base: "sm", md: "md" }} color="brand.700" fontFamily="heading">
                  Business Hours
                </Heading>
                <Text color="brand.600">
